...
```{r}
candidates.df <- as.data.frame(candidates)


candidates_TLPs <- candidates.df %>%
  filter(ID == "Glyma.01G165400" | ID == "Glyma.01G165600" | ID == "Glyma.01G165800" | ID == "Glyma.01G217600" | ID == "Glyma.01G217700" | ID == "Glyma.02G047400" | ID == "Glyma.02G220900" | ID == "Glyma.02G249500" | ID == "Glyma.04G023700" | ID == "Glyma.04G034300" | ID == "Glyma.04G176200" | ID == "Glyma.04G225800" | ID == "Glyma.05G169700" | ID == "Glyma.05G204600" | ID == "Glyma.05G204800" | ID == "Glyma.05G245800" | ID == "Glyma.06G023900" | ID == "Glyma.06G139000" | ID == "Glyma.06G189100" | ID == "Glyma.07G135100" | ID == "Glyma.08G053600" | ID == "Glyma.08G128000" | ID == "Glyma.08G172700" | ID == "Glyma.09G003600" | ID == "Glyma.10G060300" | ID == "Glyma.10G060800" | ID == "Glyma.10G061000" | ID == "Glyma.10G061700" | ID == "Glyma.10G061800" | ID == "Glyma.10G062100" | ID == "Glyma.11G025600" | ID == "Glyma.11G077700" | ID == "Glyma.11G077800" | ID == "Glyma.11G106100" | ID == "Glyma.11G106200" | ID == "Glyma.11G140800" | ID == "Glyma.11G220700" | ID == "Glyma.12G031000" | ID == "Glyma.12G031200" | ID == "Glyma.12G064300" | ID == "Glyma.12G238900" | ID == "Glyma.13G082700" | ID == "Glyma.14G077267" | ID == "Glyma.14G077333" | ID ==  "Glyma.14G077400" | ID == "Glyma.14G163700" | ID == "Glyma.14G188400" | ID == "Glyma.14G219600" | ID == "Glyma.15G254700" | ID == "Glyma.16G126900" | ID == "Glyma.16G127100" | ID == "Glyma.17G248300" | ID == "Glyma.17G258500" | ID == "Glyma.17G258600" | ID == "Glyma.19G018400")

uvalues_candidates_tlps <- as.data.frame(unique(candidates_TLPs$ID))
uvalues_CANDIDATES_TLPS_count<- candidates_TLPs %>%
  count(ID, sort = TRUE)
...
mining_ppachyrhizi <- mine_candidates(
  ...
  marker_ranges = snp_grangeslist_biotic$Ppachyrhizi,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
  sample_group = c("Ppa_stress_sus_24h", "Ppa_stress_res_24h"))
...
mining_hglycines <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$Hglycines,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
  sample_group = c("Hgl_stress", "Hgl_stress_5days", "Hgl_stress_10days", 
"Hgl_stress_15days", "Hgl_stress_virulent", "Hgl_stress_avirulent"))
...
mining_fvirguliforme <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$Fvirguliforme,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
...
mining_ssclerotiorum <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$Ssclerotiorum,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
...
mining_psojae <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$Psojae,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
...
mining_fgraminearum <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$Fgraminearum,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
...
mining_mincognita <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$Mincognita,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
  sample_group = c("Min_stress_4days_sus", "Min_stress_12days_sus", "Min_stress_30days_sus", "Min_stress_4days_tol", "Min_stress_12days_tol", "Min_stress_30days_tol"))

length(unique(mining_mincognita$gene))

# S. litura - DOES NOT EXIST IN METADATA

# SMV 

mining_smv <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$SMV,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
  sample_group = c("SMV_stress_8hpi_sus", "SMV_stress_6hpi_sus", "SMV_stress_4hpi_sus", "SMV_stress_2hpi_sus", "SMV_stress_0hpi_sus", "SMV_stress_8hpi_res", "SMV_stress_6hpi_res", "SMV_stress_4hpi_res", "SMV_stress_2hpi_res", "SMV_stress_0hpi_res", "SMV_G5H_8hpi", "SMV_G5H_24hpi", "SMV_G5H_54hpi", "SMV_G7H_8hpi", "SMV_G7H_54hpi", "SMV_G7H_24hpi"))

length(unique(mining_SMV$gene))

# F. equiseti - DOES NOT EXIST IN METADATA

# D. phaseolorum - DOES NOT EXIST IN METADATA

#PMV - DOES NOT EXIST IN METADATA

# A. glycines

mining_aglycines <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$Aglycines,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
  sample_group = c("Agl_stress_6h", "Agl_stress_12h", "Agl_stress_SCN_30d_R1", "Agl_stress_SCN_30d_R2", "Agl_stress_SCN_30d_R3", "Agl_stress_Aphid_30d_R1", "Agl_stress_Aphid_30d_R2", "Agl_stress_Aphid_30d_R3", "Agl_stress_SCNAphid_30d_R1", "Agl_stress_SCNAphid_30d_R2", "Agl_stress_SCNAphid_30d_R3", "Agl_stress_SCN_30d_R1", "Agl_stress_SCN_30d_R2", "Agl_stress_SCN_30d_R3", "Agl_stress_SCN_5d_R1", "Agl_stress_SCN_5d_R2", "Agl_stress_SCN_5d_R3", "Agl_stress_Aphid_5d_R1", "Agl_stress_Aphid_5d_R2", "Agl_stress_Aphid_5d_R3", "Agl_stress_SCNAphid_5d_R1", "Agl_stress_SCNAphid_5d_R2", "Agl_stress_SCNAphid_5d_R3", "Agl_stress_24HAI_antixenotic", "Agl_stress_96HAI_susceptible", "Agl_stress_48HAI_susceptible", "Agl_stress_24HAI_susceptible", "Agl_stress_96HAI_antibiotic", "Agl_stress_48HAI_antibiotic", "Agl_stress_24HAI_antibiotic", "Agl_stress_96HAI_antixenotic", "Agl_stress_48HAI_antixenotic"))
  
  length(unique(mining_aglycines$gene))


# X. axonopodis - DOES NOT EXIST IN METADATA

# TRSV - DOES NOT EXIST IN METADATA

# BPMV

mining_bpmv <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$BPMV,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
  sample_group = c("BPM_stress"))

length(unique(mining_bpmv$gene))

# P. gregata

mining_pgregata <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$Pgregata,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
  sample_group = c("Pgr_stress_res", "Pgr_stress_sus", "Pgr_stress_12h", "Pgr_stress_24h", "Pgr_stress_36h"))
length(unique(mining_pgregata$gene))

# C. gregata - DOES NOT EXIST IN METADATA


# M. phaseolina - REMOVED AFTER preprocess

# P. includens - DOES NOT EXIST IN METADATA

# R. reniformis

mining_rreniformis <- mine_candidates(
  gene_ranges = gff_gene, 
  marker_ranges = snp_grangeslist_biotic$Rreniformis,
  exp = exp_biotic_2,
  gcn = gcn_biotic,
  guides = guides_biotic,
  metadata = metadata_biotic,
  sample_group = c("Rre_stress_3days", "Rre_stress_6days", "Rre_stress_9days", "Rre_stress_12days"))
length(unique(mining_rreniformis$gene))

# E. varivestis - DOES NOT EXIST IN METADATA


# E. Fabae - DOES NOT EXIST IN METADATA


# A. gemmatalis - DOES NOT EXIST IN METADATA


# D aspalathi - DOES NOT EXIST IN METADATA

# C. sojina - DOES NOT EXIST IN METADATA

# P. sylvaticum - DOES NOT EXIST IN METADATA



which(duplicated(row.names()))
```
